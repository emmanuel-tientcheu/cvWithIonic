...
export class AppComponent {
  ...
  degrees = ['BACCALAURÉAT', 'PROBATOIRE', 'BEPC', 'CEP'];
  ...
  getDocumentDefinition() {
    ...
    return {
      ...
      info: {
        ...
        subject: 'CURICULUM VITEA',
        keywords: 'CREATION DES CV',
      },
        styles: {
          header: {
            fontSize: 18,
      ...
      exs.push(
        [{
          columns: [
            ...
            {
              text: 'Experiences : ' + experience.experience + ' Mois',
              alignment: 'right'
            }
          ]
        }]
